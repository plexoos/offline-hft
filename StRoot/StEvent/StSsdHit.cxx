/***************************************************************************
 *
 * $Id: StSsdHit.cxx,v 1.1 2015/01/29 19:43:46 bouchet Exp $
 *
 ...
 *
 * $Log: StSsdHit.cxx,v $
 * Revision 1.1  2015/01/29 19:43:46  bouchet
 * StSsdHit local coordinates in 3D
 *
...
static const char rcsid[] = "$Id: StSsdHit.cxx,v 1.1 2015/01/29 19:43:46 bouchet Exp $";
...
void StSsdHit::setADC(int adcp, int adcn) 
{ 
    mADC[0] = adcp; 
    mADC[1] = adcn; 
} 
 
int StSsdHit::getADC(unsigned int i) const 
{ 
    if (i<2) 
        return mADC[i]; 
    else 
