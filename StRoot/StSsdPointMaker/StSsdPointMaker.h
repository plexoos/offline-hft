// $Id: StSsdPointMaker.h,v 1.1 2015/01/29 19:51:42 bouchet Exp $
//
// $Log: StSsdPointMaker.h,v $
// Revision 1.1  2015/01/29 19:51:42  bouchet
...
class StSsdPointMaker : public StMaker {
 ...
 protected:
  ...
  Int_t correctFactor[1920][2]; // coding is [iLadder*20 + iWafer*6 + iChip][iSide] 
  virtual const char *GetCVS() const 
  {static const char cvs[]="Tag $Name:  $ $Id: StSsdPointMaker.h,v 1.1 2015/01/29 19:51:42 bouchet Exp $ built "__DATE__" "__TIME__ ; return cvs;}
