 ...
 **********************************************************
 * update :
 * 1) SsdHit local position in 3D
 * 2) xL and zL are smeared
 * 3) RemoveTriangle() method temporary disabled
 *
 */
...
Int_t StSsdFastSimMaker::Make()
{
  ...
  if(g2t_ssd_hit){
	...
	Double_t xl[3]={0.,0.,0.};
	//TGeoHMatrix* sensorMatrix = (TGeoHMatrix*)gStSstDbMaker->getHMatrixSensorOnGlobal(currLadder+1,currWafNumb+1);
