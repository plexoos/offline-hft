...
// constructor
StIstCalibrationMaker::StIstCalibrationMaker( const char* name ) : StMaker( name ), mTimeBinMask(0xFF), evtIdx(0), mPedTable("pedestalNoise_ist.dat"), mCmnTable("cmNoise_ist.dat"), mHasFinished(0), mIstDbMaker(0), mRootFilename("calibrationQA_ist.root") {
